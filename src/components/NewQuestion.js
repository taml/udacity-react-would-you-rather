                    ...
                    <div className="flex h-screen justify-center items-center">
                        <div className="w-2/5 text-center bg-gray-700 rounded-xl">
                            ...
                            <form onSubmit={this.handleSubmit}>
                                <textarea className="block w-60 mx-auto rounded-md text-white bg-gray-600 border-transparent focus:border-gray-500 focus:bg-gray-600 focus:ring-0" placeholder="Have a life supply of coffee?" value={optionOne} onChange={this.handleOptionOne}/>
                                <p className="text-white py-2">Or</p>
                                <textarea className="block w-60 mx-auto rounded-md text-white bg-gray-600 border-transparent focus:border-gray-500 focus:bg-gray-600 focus:ring-0" placeholder="Have a life supply of pizza?" value={optionTwo} onChange={this.handleOptionTwo}/>
                                <br></br>
